...
extension TypeWrapperProtocol where WrappedType : PHAsset {
    ...
    ///   - completion: 结果回调
    @available(iOS 9.1, *)
    public func requestLivePhoto(size : CGSize,resize mode: PHImageContentMode ,_ progresshandler: PHAssetImageProgressHandler?,completion:@escaping (_ livePhoto:  PHLivePhoto?, _ dic : [AnyHashable:Any]?) -> Void) {
